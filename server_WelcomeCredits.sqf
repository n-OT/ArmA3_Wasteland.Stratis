...
_role1 = "Welcome to";
_role1names = ["[IAm]Gaming Co. | Stratis Wasteland"];
_role2 = "Admins";
_role2names = ["[IAm]n O T", "[IAm]Teku", "[IAm]Josh"];
_role3 = "Server mod";
_role3names = ["A3Wasteland v1.1"];
_role4 = "Website";
_role4names = ["www.iamgaming.co"];
_role5 = "PayPal";
_role5names = ["teku@anticraft.info"];
_role6 = "TeamSpeak";
_role6names = ["iamgaming.co"]
_role7 = "Please report any hackers or bugs to admins!";
_role7names = ["Have Fun!"];
